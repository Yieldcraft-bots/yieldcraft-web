      ...
      <div className="mx-auto max-w-6xl px-4 py-20">
        ...
        <div className="mb-14 max-w-3xl">
          ...
          <p className="mt-6 text-lg text-slate-300">
            Choose the YieldCraft system that fits
            how you want to operate.
          </p>

          <p className="mt-3 text-sm leading-6 text-slate-400">
            Your capital stays in your connected account.
            YieldCraft only operates the products and
        ...
        {/* ATLAS */}
        <section className="relative mt-12 overflow-hidden rounded-3xl border border-sky-500/20 bg-slate-900/40 p-8">
          <div className="max-w-4xl">
            <p className="mb-2 inline-flex rounded-full border border-sky-500/20 bg-sky-500/10 px-3 py-1 text-xs font-semibold text-sky-300">
            ...
            <p className="mt-4 max-w-3xl text-base leading-7 text-slate-300">
              Build a long-term portfolio around the
              allocation you choose. Atlas combines
              client-defined portfolio targets with
              disciplined accumulation and protected
              execution controls.
            </p>
            ...
            <div className="mt-6 grid gap-4 md:grid-cols-2">
              <AtlasFeature
                ...
                text="Set the target percentages for the Atlas assets you want represented in your portfolio."
              />

              <AtlasFeature
                title="Multi-asset portfolio"
                text="Atlas is designed across digital assets, public equities, and selected additional exposures supported by the platform."
              />

              <AtlasFeature
                title="Disciplined accumulation"
                text="Capital can accumulate toward portfolio targets rather than forcing constant activity."
              />

              <AtlasFeature
                title="Client-controlled exits"
                text="Atlas is built around accumulation. Clients remain responsible for selling and withdrawal decisions."
              />
            </div>
            ...
            <div className="mt-6 rounded-2xl border border-slate-800 bg-slate-950/40 p-5">
              ...
              <p className="mt-2 text-sm leading-6 text-slate-400">
                Atlas requires a separate Coinbase
                account or dedicated portfolio from
                Pulse and other active YieldCraft
            ...
            <div className="mt-5 rounded-2xl border border-amber-400/20 bg-amber-400/5 p-5">
              ...
              <p className="mt-2 text-sm leading-6 text-slate-400">
                Saving an Atlas allocation does not
                itself submit an order. Asset
                availability, planning, market
                eligibility, approvals, authorization,
                and protected execution remain separate
                stages.
              </p>
            </div>
            ...
            <p className="mt-5 text-xs leading-5 text-slate-500">
              Asset availability may vary by product
              readiness, connected account capability,
              market session, exchange support, and
          ...
          <div className="mt-7 flex flex-wrap items-center gap-4">
            ...
            <Link
              ...
              className="rounded-full border border-sky-500/30 bg-sky-500/10 px-4 py-2 text-sm font-semibold text-sky-200 hover:border-sky-400"
            >
              Atlas Quick Start
            </Link>
        ...
        <div className="mt-8 rounded-2xl border border-slate-800 bg-slate-900/30 p-5">
          <p className="text-xs leading-5 text-slate-500">
            YieldCraft systems do not guarantee returns
            or eliminate investment risk. Markets can
            lose value. Clients remain responsible for
            funding, withdrawals, investment objectives,
            selling decisions, and tax considerations.
          </p>
        </div>
      </div>
    </main>
