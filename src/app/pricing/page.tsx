      ...
      <section className="yc-section">
        ...
        <div className="pricing-grid">
          <article className="card">
            ...
            <p className="blurb">Conservative scalping targeting <b>2–4% monthly</b>.</p>
          ...
          <article className="card">
            ...
            <p className="blurb">Advanced signal layer for standalone use or paired with bots.</p>
            <div className="metrics">
          ...
          <article className="card">
            ...
            <p className="blurb">Momentum bot for explosive altcoin moves (experienced traders).</p>
            <div className="metrics">
